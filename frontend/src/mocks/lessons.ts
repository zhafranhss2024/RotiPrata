...
export const mockLessons: Lesson[] = [
  {
    ...
    header_media_url: "/flags/spanishSvg.svg",
    ...
    badge_icon_url: "/icon-images/QUEST_STREAK.svg",
    difficulty_level: 1,
    category_id: "1",
    is_published: true,
  ...
  },
  {
    ...
    header_media_url: "/flags/germanSvg.svg",
    ...
    badge_icon_url: "/icon-images/QUEST_PERFECT.svg",
    difficulty_level: 2,
    category_id: "2",
    is_published: true,
  ...
  },
  {
    ...
    header_media_url: "/flags/frenchSvg.svg",
    ...
    badge_icon_url: "/icon-images/QUEST_ACCURACY.svg",
    difficulty_level: 3,
    category_id: null,
    is_published: true,
