...
public class BrowsingService {
    ...
    public void saveHistory(String contentId, String lessonId, String title, String accessToken) {
    ...
    public List<SaveHistoryDTO> fetchHistory(String userId, String accessToken) {
    ...
    public void purgeHistory(String userId, String accessToken) {
